...
export const router = createBrowserRouter([
  { path: '/login', element: <Login /> },
  {
    ...
    children: [
      ...
      {
        path: 'espacos/novo',
        element: <ProtectedRoute roles={['admin']}><CreateEspaco /></ProtectedRoute>,
      },
      {
        path: 'espacos/:id',
        element: <ProtectedRoute roles={['admin']}><EditEspaco /></ProtectedRoute>,
      },
      {
        path: 'clientes/buscar',
        element: <ProtectedRoute><BuscarOuCriarCliente /></ProtectedRoute>,
      },
      {
        path: 'clientes/:cpf',
        element: <ProtectedRoute><ClientePorCPF /></ProtectedRoute>,
      },
      ...
      {
        path: 'users',
        element: <ProtectedRoute roles={['admin']}><ListUsers /></ProtectedRoute>,
      },
      {
        path: 'users/novo',
